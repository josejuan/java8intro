...
/**
 * Serializes and deserializes instances of Message.
 * <p>
...
public abstract class GeneratedMessageEntityStoreSerializerImpl implements EntityStoreSerializer<Message> {
    ...
    private final static int ENDPOS_VALUE = 4;
    private final static int VARSIZE_BEGINS = 8;
    
    protected GeneratedMessageEntityStoreSerializerImpl(final LongFunction<ByteBuffer> bufferFinder, final LongToIntFunction offsetFinder) {
        this.bufferFinder = requireNonNull(bufferFinder);
        this.offsetFinder = requireNonNull(offsetFinder);
    }
    
    @Override
    public BiConsumer<ByteBuffer, Message> serializer() {
        return (buffer, entity) -> {
            int varSizePos = 0;
            buffer.putInt(FIELD_ID, entity.getId());
            varSizePos += ByteBufferUtil.putArrayAbsolute(buffer, VARSIZE_BEGINS + varSizePos, entity.getValue().getBytes());
            buffer.putInt(ENDPOS_VALUE, varSizePos);
            buffer.position(0);
    ...
    @Override
    public LongFunction<Message> deserializer() {
        return ref -> {
            final ByteBuffer buffer = bufferFinder.apply(ref);
            final int offset = offsetFinder.applyAsInt(ref);
            final Message entity = new MessageImpl();
            entity.setId(buffer.getInt(offset + FIELD_ID));
            try {
                entity.setValue(Utf8Util.deserialize(buffer,
                    offset + VARSIZE_BEGINS + 0,
                    offset + VARSIZE_BEGINS + buffer.getInt(offset + ENDPOS_VALUE)
                ));
    ...
    @Override
    public Class<?> deserializedType(final ColumnIdentifier<Message> colId) {
        if (colId instanceof Message.Identifier) {
            final Message.Identifier _id = (Message.Identifier) colId;
            switch (_id) {
                case ID    : return int.class;
                case VALUE : return String.class;
                default : {
    ...
    @Override
    public <FK_ENTITY> LongUnaryOperator finder(final ColumnIdentifier<Message> colId, final ColumnIdentifier<FK_ENTITY> fkColId) {
        return finder(singletonList(colId), singletonList(fkColId));
    }
    
    @Override
    public <FK_ENTITY> LongUnaryOperator finder(final List<ColumnIdentifier<Message>> cols, final List<ColumnIdentifier<FK_ENTITY>> fkCols) {
        throw new UnsupportedOperationException("Message has no foreign references.");
    }
    ...
    @Override
    public LongPredicate isNull(final ColumnIdentifier<Message> colId) {
        if (colId instanceof Message.Identifier) {
            final Message.Identifier _id = (Message.Identifier) colId;
            switch (_id) {
                case ID    : 
                case VALUE : return ALWAYS_FALSE;
                default : {
                    throw new UnsupportedOperationException(
                        String.format("Unknown enum constant '%s'.", _id)
                    );
    ...
    @Override
    public LongPredicate isPresent(final ColumnIdentifier<Message> colId) {
        if (colId instanceof Message.Identifier) {
            final Message.Identifier _id = (Message.Identifier) colId;
            switch (_id) {
                case ID    : 
                case VALUE : return ALWAYS_TRUE;
                default : {
                    throw new UnsupportedOperationException(
                        String.format("Unknown enum constant '%s'.", _id)
                    );
    ...
    @Override
    public LongToByteFunction byteDeserializer(final ColumnIdentifier<Message> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToShortFunction shortDeserializer(final ColumnIdentifier<Message> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToIntFunction intDeserializer(final ColumnIdentifier<Message> colId) {
    ...
    @Override
    public LongUnaryOperator longDeserializer(final ColumnIdentifier<Message> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToFloatFunction floatDeserializer(final ColumnIdentifier<Message> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToDoubleFunction doubleDeserializer(final ColumnIdentifier<Message> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToCharFunction charDeserializer(final ColumnIdentifier<Message> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongToBooleanFunction booleanDeserializer(final ColumnIdentifier<Message> colId) {
        throw new UnsupportedOperationException(
    ...
    @Override
    public LongFunction<?> objectDeserializer(final ColumnIdentifier<Message> colId) {
        if ("value".equals(colId.getColumnId())) {
            return ref -> {
                final ByteBuffer buffer = bufferFinder.apply(ref);
                final int offset = offsetFinder.applyAsInt(ref);
                try {
    ...
    @Override
    public BiLongToIntFunction comparator(final ColumnIdentifier<Message> colId) {
        if (colId instanceof Message.Identifier) {
            final Message.Identifier _id = (Message.Identifier) colId;
            switch (_id) {
                ...
                case VALUE : return (aRef, bRef) -> {
                    ...
                    final int aEnds   = aOffset + VARSIZE_BEGINS + aBuf.getInt(aOffset + ENDPOS_VALUE);
                    final int bEnds   = bOffset + VARSIZE_BEGINS + bBuf.getInt(bOffset + ENDPOS_VALUE);
    ...
    @Override
    public BiLongToIntFunction comparatorNullsLast(final ColumnIdentifier<Message> colId) {
        if (colId instanceof Message.Identifier) {
            final Message.Identifier _id = (Message.Identifier) colId;
            switch (_id) {
                case ID    : return (aRef, bRef) -> Integer.compare(
    ...
    @Override
    public LongToIntFunction compareToByte(final ColumnIdentifier<Message> colId, final byte value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type byte.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToShort(final ColumnIdentifier<Message> colId, final short value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type short.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToInt(final ColumnIdentifier<Message> colId, final int value) {
        if ("id".equals(colId.getColumnId())) {
            {
    ...
    @Override
    public LongToIntFunction compareToLong(final ColumnIdentifier<Message> colId, final long value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type long.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToFloat(final ColumnIdentifier<Message> colId, final float value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type float.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToDouble(final ColumnIdentifier<Message> colId, final double value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type double.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToBoolean(final ColumnIdentifier<Message> colId, final boolean value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type boolean.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToChar(final ColumnIdentifier<Message> colId, final char value) {
        throw new UnsupportedOperationException(
            String.format("The column '%s' is either unknown or not of type char.", colId.getColumnId())
        );
    }
    ...
    @Override
    public LongToIntFunction compareToObject(final ColumnIdentifier<Message> colId, final Object value) {
        if ("value".equals(colId.getColumnId())) {
            {
    ...
    @Override
    public LongToIntFunction compareToNull(final ColumnIdentifier<Message> colId) {
        if (colId instanceof Message.Identifier) {
            final Message.Identifier _id = (Message.Identifier) colId;
            switch (_id) {
                case ID    : return ALWAYS_LESS;
                case VALUE : return ref -> bufferFinder.apply(ref).getInt(offsetFinder.applyAsInt(ref) + ENDPOS_VALUE) < 0 ? 0 : -1;
                default : {
                    throw new UnsupportedOperationException(
                        String.format("Unknown enum constant '%s'.", _id)
                    );
    ...
    @Override
    public LongPredicate newPredicate(final ColumnIdentifier<Message> colId, final EntityStorePredicate predicate) {
        if (colId instanceof Message.Identifier) {
            final Message.Identifier _id = (Message.Identifier) colId;
            switch (_id) {
                case ID    : return ref -> {
                ...
                case VALUE : return ref -> {
                    ...
                    return predicate.test(buffer,
                        ...
                        rowOffset + VARSIZE_BEGINS + buffer.getInt(rowOffset + ENDPOS_VALUE)
                    );
                };
                default : {
                    throw new UnsupportedOperationException(
    ...
    @Override
    public LongToIntFunction newCompareTo(final ColumnIdentifier<Message> colId, final EntityStoreCompareTo compareTo) {
        if (colId instanceof Message.Identifier) {
            final Message.Identifier _id = (Message.Identifier) colId;
            switch (_id) {
                case ID    : return ref -> {
    ...
    @Override
    public BiLongToIntFunction newComparator(final ColumnIdentifier<Message> colId, final EntityStoreComparator comparator) {
        if (colId instanceof Message.Identifier) {
            final Message.Identifier _id = (Message.Identifier) colId;
            switch (_id) {
                ...
                case VALUE : return (aRef, bRef) -> {
                    ...
                    final int bRowOffset = offsetFinder.applyAsInt(bRef);
                    return comparator.compare(
                        aBuffer, aRowOffset + VARSIZE_BEGINS, aRowOffset + VARSIZE_BEGINS + aBuffer.getInt(aRowOffset + ENDPOS_VALUE), 
                        bBuffer, bRowOffset + VARSIZE_BEGINS, bRowOffset + VARSIZE_BEGINS + bBuffer.getInt(bRowOffset + ENDPOS_VALUE)
                    );
                };
                default : {
                    throw new UnsupportedOperationException(
    ...
    public LongToIntFunction sizeOf() {
        return ref -> VARSIZE_BEGINS + Math.abs(bufferFinder.apply(ref).getInt(offsetFinder.applyAsInt(ref) + ENDPOS_VALUE));
    }
}